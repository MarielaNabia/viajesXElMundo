         ...
         {/*  <AdbIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} /> */}
              ...
              {pages.map((page, index) => (
                <MenuItem  onClick={handleCloseNavMenu}>
                  <Typography sx={{textDecoration: "None"}} textAlign="center">
                    <LinkRouter key={index}  to={page} style={{ textDecoration: "None"}}>{page}</LinkRouter>
                    </Typography>
                </MenuItem>
              ))}
            </Menu>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page,index) => (
              ...
              >
                <LinkRouter to={page} key={index.page} style={{color: 'white', textDecoration: "None"}}>{page}</LinkRouter>
              </Button>
            ))}
          </Box>
            ...
            >
              {settings.map((setting, index) => (
                <MenuItem onClick={handleCloseUserMenu}>
                  <Typography key={index.setting} textalign="center">{setting}</Typography>
